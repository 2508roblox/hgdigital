...
<head>
    ...
    <style>
        .cybersecurity h1, .cybersecurity h2, .cybersecurity h3, .cybersecurity h4, .cybersecurity h5, .cybersecurity h6, .main-menu ul li a, .footer-style-three .footer-widget .xb-item--list {
