        ...
        <div class="cta-wrap">
            <div class="cta-inner ul_li_between">
                <div class="xb-item--holder wow fadeInLeft" data-wow-delay="100ms"
                    ...
                    <h2 class="xb-item--title">Tạo ấn tượng với website chất lượng.</h2>
                    <span class="xb-item--content">Đặt lịch tư vấn miễn phí để có được giải pháp thiết kế website bạn cần.</span>
                    <div class="xb-btn mt-45">
                        <a href="/contact" class="thm-btn thm-btn--aso thm-btn--aso_white">Đặt lịch tư vấn miễn phí</a>
                    </div>
                </div>
